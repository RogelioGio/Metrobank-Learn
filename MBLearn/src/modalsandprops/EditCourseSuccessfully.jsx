import { faBookOpen, faTrash, faUserPen } from "@fortawesome/free-solid-svg-icons"
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome"
import { Dialog, DialogBackdrop, DialogPanel } from "@headlessui/react"
import axiosClient from "../axios-client"
import { useEffect, useState } from "react"

const EditCourseSuccesFully = ({open,close,classname}) => {
    return (
                            ...
                            {/* Header */}
                                <div className="py-4 mx-4 border-divider flex flex-col items-center justify-center gap-2">
                                    ...
                                    <div className="text-center flex-col flex gap-1">
                                        ...
                                        <p className="text-unactive font-text text-sm">The selected course is successfuly updated</p>
                                    </div>
                                </div>
...
export default EditCourseSuccesFully
