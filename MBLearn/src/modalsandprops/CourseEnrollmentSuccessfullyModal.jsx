...
const CourseEnrollmentSuccesfully = ({open, close, result, course, duration, learner, date, tab }) => {
                        ...
                        <div className='bg-white rounded-md h-full p-5 flex flex-col'>
                            ...
                            <div className="pb-2 px-4 flex flex-col justify-center items-center w-full">
                                ...
                                <div className="flex flex-col items-center justify-center">
                                    <p className="font-header text-primary text-xl">Enrollment Successfully</p>
                                    <p className="font-text text-primary text-xs">The Learners chosen is successfully enrolled</p>
                                </div>
                            </div>
