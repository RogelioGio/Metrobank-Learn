...
const CancelAssigningModal = ({open,close,discardChanges}) => {
    return(
                    ...
                    <DialogPanel transition className='relative overflow-hidden transform rounded-md bg-white text-left shadow-xl transition-all data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in'>
                        <div className='bg-white rounded-md h-full w-fit p-5 flex flex-col items-center justify-center'>
                            <div className="text-center flex-col flex gap-1 px-2 pb-4 pt-2">
                                <h1 className="text-primary font-header text-xl">Cancel Assigning</h1>
                                <p className="text-unactive font-text text-xs">You have unsaved changes. <br/> Are you sure you want to leave without assinging the seleced course admins?</p>
                            </div>
...
export default CancelAssigningModal
