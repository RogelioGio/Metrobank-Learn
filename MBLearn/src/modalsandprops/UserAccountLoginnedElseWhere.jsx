...
const UserAccoountLoginnedElseWhere = ({open,close}) => {
    return (
                        ...
                        <DialogPanel className='bg-white rounded-lg shadow-lg p-4 max-w'>
                            <div className='flex flex-col items-center p-5 gap-4'>
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <p className="font-text text-center text-unactive">Youre account was logged-in in different device. <br/> only one session per account is required.</p>
                                </div>
...
export default UserAccoountLoginnedElseWhere;
