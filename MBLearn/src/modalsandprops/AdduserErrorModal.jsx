...
const AddUserErrorModal = ({error, close, message, desc={} }) => {
    return (
                    ...
                    <DialogPanel transition className='relative overflow-hidden transform rounded-md bg-white text-left shadow-xl transition-all data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in'>
                        <div className='bg-white rounded-md h-full w-[50vw] p-5 flex flex-row'>
                            ...
                            <div className="p-5">
                                    ...
                                    {/* Body */}
                                    <div className="py-4">
                                        <p className="font-text text-sm text-unactive">The user could not be added to the system records due to an error. The operation has been aborted due to the following reason:</p>
                                    </div>
                                    {/* Error Message */}
                                    <div>
                                        {/* Specific Error */}
...
export default AddUserErrorModal
