...
<head>
  ...
  <style>
    ...
    .email-header {
      background-color: #003366; /* fallback solid color for Outlook */
  ...
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-header">
        <h1>Metrobank Course Assignment</h1>
      </div>
      ...
      <div class="email-body">
        ...
        <p>
          You have been assigned to the course titled: <strong>“{{ $courseName }}”</strong>.
        </p>

        <p>
          Assigned by: <strong>{{ $assignerName }}</strong>
        </p>

        <a href="{{ $courseUrl }}" class="cta-button">View Your Course</a>

        <p>
          Please log in to the portal to view more details about your assignment.
        </p>
