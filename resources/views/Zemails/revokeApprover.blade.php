...
<head>
  ...
  <title>Course Approval Revoked</title>
  <style>
    body {
      margin: 0;
      padding: 0;
  ...
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-header">
        <h1>Metrobank Course Approval Revoked</h1>
      </div>
      ...
      <div class="email-body">
        ...
        <p>
          Your approval for the course titled: <strong>“{{ $courseName }}”</strong> has been revoked.
        </p>

        <p>
          Revoked by: <strong>{{ $assignerName }}</strong>
        </p>
