  ...
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-body">
        ...
        <p>
          <strong>{{ $reviewerName }}</strong> has <strong>{{ strtolower($response) }}</strong> the course titled 
          <strong>“{{ $courseName }}”</strong>.
        </p>

        <p>
          You can review the course status and modify the course accordingly.
        </p>

        <a href="{{ $courseUrl ?? '#' }}" class="cta-button">View {{ ucfirst($response) }} course</a>
