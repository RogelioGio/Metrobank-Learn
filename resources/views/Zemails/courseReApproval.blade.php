...
<head>
  ...
  <title>Course Re-Approval Invitation</title>
  <style>
    body {
      margin: 0;
      padding: 0;
  ...
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-body">
        ...
        <p>
          You have been invited by <strong>{{ $assignerName }}</strong> to <strong>re-approve</strong> the course titled
          <strong>“{{ $courseName }}”</strong>.
        </p>

        <p>
          Please review the course and provide your feedback or approval at your earliest convenience.
        </p>

        <a href="{{ $courseUrl }}" class="cta-button" target="_blank" rel="noopener noreferrer">
          View Course for Re-Approval
        </a>

        <p>
          Thank you for your continued collaboration.<br/>
